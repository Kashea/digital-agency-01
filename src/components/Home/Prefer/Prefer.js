...
const Prefer = () => {
  return (
    ...
    <p className='pt-12 pb-6 app__text'>Kids believe that the turtle was hardworking, but the truth is that if the rabbit had not  been distracted, the turtle would have lost the race. You alone, looking after investment and creativity along with your business, will make you the distracted rabbit. WebDev Private Limited comes into the story now, follows the rabbit through the race, and then reminds him of his self-worth and power. The rabbit stays the fastest and smartest in the jungle!</p>
